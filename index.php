        ...
        <div class="container">
            <div class="row">
                <section class="content__left col-md-8">
                    <div class="block">
                        <a href="/articles.php">All categories</a>
                        <h3>New in blog</h3>
                    ...
                    <div class="block">
                        <a href="/articles.php?categorie=6">All articles</a>
                        <h3>Security [New in block]</h3>
                        <div class="block__content">
                            <div class="articles articles__horizontal">
                    ...
                    <div class="block">
                        <a href="/articles.php?categorie=4">All categories</a>
